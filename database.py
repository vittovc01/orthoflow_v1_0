...
AGENTI = [
    "Pasquale", "Maurizio", "Mariano Borrelli", "Mariano Gargiulo",
    "Susi", "Giampiero", "Francesco De Lisi", "Francesco Cirillo", "Cristiano"
]
...
def init_db():
    ...
    cur.execute("""CREATE TABLE IF NOT EXISTS agenti(
        id INTEGER PRIMARY KEY AUTOINCREMENT,
        nome TEXT UNIQUE
    )""")

    cur.execute("""CREATE TABLE IF NOT EXISTS magazzino(
        id INTEGER PRIMARY KEY AUTOINCREMENT,
        codice TEXT,
        descrizione TEXT,
        lotto TEXT,
    ...
    cur.execute("""CREATE TABLE IF NOT EXISTS offerte_header(
        id INTEGER PRIMARY KEY AUTOINCREMENT,
        nome_offerta TEXT,
        linea TEXT,
        data_inizio TEXT,
    ...
    cur.execute("""CREATE TABLE IF NOT EXISTS offerte_clienti(
        id INTEGER PRIMARY KEY AUTOINCREMENT,
        offerta_id INTEGER,
        codice_cliente TEXT
    )""")

    cur.execute("""CREATE TABLE IF NOT EXISTS offerte_prezzi(
        id INTEGER PRIMARY KEY AUTOINCREMENT,
        offerta_id INTEGER,
        codice TEXT,
        descrizione TEXT,
    ...
    cur.execute("""CREATE TABLE IF NOT EXISTS interventi(
        id INTEGER PRIMARY KEY AUTOINCREMENT,
    ...
    cur.execute("""CREATE TABLE IF NOT EXISTS righe_intervento(
        id INTEGER PRIMARY KEY AUTOINCREMENT,
    ...
    cur.execute("""CREATE TABLE IF NOT EXISTS ddt(
        id INTEGER PRIMARY KEY AUTOINCREMENT,
        numero_ddt TEXT,
        data_ddt TEXT,
        tipo_ddt TEXT,
    ...
    cur.execute("""CREATE TABLE IF NOT EXISTS ddt_righe(
        id INTEGER PRIMARY KEY AUTOINCREMENT,
        ddt_id INTEGER,
        codice TEXT,
        descrizione TEXT,
    ...
    cur.execute("""CREATE TABLE IF NOT EXISTS chiusure(
        id INTEGER PRIMARY KEY AUTOINCREMENT,
        mese TEXT,
        numero_ordine TEXT,
        codice TEXT,
